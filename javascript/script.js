...
function updateTimer() {
  const targetDate = new Date("december 7, 2025 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542964612818'; // Número para el primer botón
  const phoneNumber2 = '542964404264'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '542964612818'; // Número para el primer botón
  const recipientNumber2 = '542964404264'; // Número para el segundo botón
